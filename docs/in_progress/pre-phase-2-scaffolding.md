...
**Status:** IN PROGRESS — scaffolding between **Phase 1** (shipped: `docs/architecture/media-query-engine.md`)
and **Phase 2** (`phase-2-actuator-role-and-task-manifest.md`). TDD (backend). **Depends on:** Phase 1.
