...
import type { AggregatedRatings } from "../../../server/utils/ratingsAggregation.ts";
                    ...
                    <div className={styles.headerContent}>
                        ...
                        <div className={styles.averageBlock}>
                            ...
                            <span className={styles.sourcesCount}>
                                {summary.foundSources} of {summary.totalSources}{" "}
                                sources
                            </span>
                        </div>
                    </div>
            ...
            <div className={styles.sources}>
                {tmdb && (
                    <SourceCard name="TMDB" found={tmdb.found}>
                        ...
                        <RatingRow
                            label="Votes"
                            value={tmdb.tvVotes?.toLocaleString()}
                        />
                        <RatingRow
                            label="Popularity"
                            value={tmdb.popularity?.toFixed(1)}
                        />
                    </SourceCard>
                )}
                ...
                {omdb && (
                    <SourceCard name="OMDB" found={omdb.found}>
                        ...
                        <RatingRow
                            label="IMDb Votes"
                            value={omdb.imdbVotes?.toLocaleString()}
                        />
                        <RatingRow
