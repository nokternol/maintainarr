...
import { type Automation, DashboardContent, type RunRecord } from './index';
...
const recentRuns: RunRecord[] = [
  ...
  {
    id: 'r3',
    automationName: 'Tag recent additions',
    action: 'tagged',
    itemCount: 3,
    relativeTime: '14h ago',
  },
...
export const AllActive: Story = () => (
  <Shell>
    <DashboardContent automations={activeAutomations} runs={recentRuns} />
  </Shell>
);
    ...
    <DashboardContent
      automations={[
        ...
        },
        {
          ...errorAutomation,
          id: 'e2',
          name: 'Sync collection tags',
          taskName: 'Sync to Plex collections',
    ...
    <DashboardContent
      automations={[
        neverRunAutomation,
        {
          ...neverRunAutomation,
          id: 'n2',
          name: 'Refresh all posters',
          queryName: 'All library items',
          taskName: 'Fetch poster from TMDB',
