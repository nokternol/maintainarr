    ...
    <div className="border border-border rounded-lg bg-surface-panel overflow-hidden">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs px-2 py-0.5 bg-primary/20 text-primary rounded">{result.type}</span>
  ...
  return (
    ...
    >
      <div className="p-6 space-y-6">
        ...
        {error && (
          <div className="p-3 bg-red-500/10 border border-red-500/30 rounded text-red-400 text-sm" role="alert">
            {error}
          </div>
        )}
